                            ...
                            <div class="container d-flex flex-column h-100">
                                ...
                                <div class="row g-0">
                                    <div class="col-12 col-lg-12 mx-auto">
                                        ...
                                        <h1 class="text-9 text-dark fw-300 mb-5 text-center">PENGUATAN TATA KELOLA
                                            MENUJU INTERNASIONALISASI UIN SUMATERA UTARA MEDAN HOTEL NIAGARA PARAPAT
                                            <br>02-04 FEBRUARI 2025
                                        </h1>
                                    </div>
                                </div>
                            </div>
